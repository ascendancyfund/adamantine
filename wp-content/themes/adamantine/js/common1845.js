...
//	$('.testimonials').siblings('.left_title').removeClass('title_bgr');
    ...
    $(function() {
        ...
        var $allVideos = $("iframe[src^='//player.vimeo.com'], iframe[src^='https://player.vimeo.com'], iframe[src^='//player.vimeo.com'], iframe[src^='//www.youtube.com'], iframe[src^='https://www.youtube.com'], iframe[src^='//www.youtube.com'], object, embed").not('.rev_slider iframe');
